...
import { CategoriaCor } from '../../dadosRelatorios/categoria-cor/categoria-cor';
import { COR_CATEGORIA_PADRAO, MODULOS_FINANCEIRO } from '../../dadosRelatorios/modulos-financeiro/modulos-financeiro';
